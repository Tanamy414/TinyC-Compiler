%{
    #include "ass6_18CS10015_18CS10055_translator.h"
...
primary_expression:             IDENTIFIER {
                                                ...
                                                {int ch;
                                                switch( ch){
                                                    case 1: for(int i=0;i<5;i++)i++; break;
                                                    case 2: if(ch){} else {int u=0;} break;
                                                    case 3: for(int i=0;i<76;i++) break;
                                                    default : break;
                                                }
                                                int n = 1; 
                                                label1: 
                                                ...
                                                if(check_func == NULL)
                                                {
                                                    ...
                                                    switch( ch){
                                                        case 1: for(int i=0;i<5;i++)i++; break;
                                                        case 2: if(ch){} else {int u=0;} break;
                                                        case 3: for(int i=0;i<76;i++){int j; j++;} break;
                                                        default : break;
                                                    }
                                                    int n = 1; 
                                                    label2: 
                                ...
                                FLOATING_CONSTANT {
                                                    ...
                                                    {int ch=3;
                                                            switch( ch){
                                                                case 1: for(int i=0;i<5;i++)i++; break;
                                                                case 2: if(ch){} else {int u=0;} break;
                                                                case 3: for(int i=0;i<76;i++){int j; j++;}
                                                                default : break;
                                                            }
                                                            int n = 1; 
                                                            label12: 
...
identifier_opt:                 IDENTIFIER {
                                                ...
                                                {int ch=3;
                                                            switch( ch){
                                                                case 1: for(int i=0;i<5;i++)i++; break;
                                                                case 2: if(ch){} else {int u=0;} break;
                                                                case 3: for(int i=0;i<90;i++){int asdds=0;} break;
                                                                default : break;
                                                            }
                                                            int n = 1; 
                                                            label74: 
